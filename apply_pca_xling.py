...
def main():
    ...
    parser.add_argument('-langs', required=True,   nargs='+',help='First language code (the first lang should be "en")')
    parser.add_argument('-word2sent', required=True,   nargs='+',help='Path to word2sent pickle')
