# swe4semantics
This repositiory provides code and static word embeddings (SWEs) proposed in our paper "[Static Word Embeddings for Sentence Semantic Representation](https://aclanthology.org/2025.emnlp-main.316)" (EMNLP 25 Main).
...
Refer to "example.py" for how to use English SWEs, and "example_xling.py" for cross-lignual ones. As denoted in the paper title, these embeddings are more effective for encoding sentences than paragraphs/documents.
