...
**Note: The code used in step 2 and 3 are designed for training bilingual SWEs (as done in our paper), but can be easily extended to mulitlingual training. For step 2, merge tword embeddings of multiple languages and apply PCA, which is done to produce the results shown in Table 10 and 11. For step 3, feed paralell sentences of multiple language pairs and jointly minimise the contrastive learning loss**
